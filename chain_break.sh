...
pref='/home/lhtran/software/rf_diffusion_pseudocycle/experiments/test_rf2aa/test_cyclic_reses_breaksym_t49'
...
/software/containers/SE3nv.sif $script --config-name=aa \
    ...
    inference.ij_visible='a-b-c-d-e' \
